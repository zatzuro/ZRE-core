...
class RealTeamSessionCases(unittest.TestCase):
    ...
    def test_swap_does_not_reset_strategy_or_car_laps(self):
        ...
        self.assertEqual(source.strategy_completed_stints[-1]['driver'],'Santiago')
        self.assertEqual(source.strategy_stint_start_lap,102)
        self.assertEqual(source.strategy_stops_completed,4)
        self.assertEqual(packet['teamContext']['driver'],'David')
